...
/* Assets Table View */
                ...
                <div className="px-3 py-2 border-b border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-2 bg-gray-100/50 dark:bg-gray-800/50">
                  ...
                  <div className="flex items-center gap-2">
                    <button 
                      ...
                      className={cn(
                        ...
                        isRefreshingPrices 
                          ...
                          : "text-gray-700 hover:bg-gray-200 dark:hover:bg-gray-800 border-gray-300 dark:border-gray-700"
                      )}
                    ...
                    <button 
                      ...
                      className="bg-gray-800 dark:bg-gray-700 text-white px-3 py-1.5 rounded-lg text-xs font-bold hover:bg-gray-900 dark:hover:bg-gray-600 transition-all flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
                            ...
                            <td className="px-3 py-2">
                              <div className="flex flex-col gap-0.5">
                                <span className={cn(
                                  ...
                                  asset.type === 'Stock' ? "bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300" :
          ...
          <Card className="h-56 flex flex-col items-center justify-center text-center rounded-xl border border-dashed border-slate-300 dark:border-slate-800 p-4">
            ...
            <button 
              ...
              className="mt-4 bg-gray-800 dark:bg-gray-700 text-white px-4 py-1.5 rounded-lg text-xs font-bold hover:bg-gray-900 dark:hover:bg-gray-600 transition-all"
            >
              Create Portfolio
            </button>
          </Card>
  ...
  return (
    <div className="min-h-[calc(100vh-72px)] flex items-center justify-center bg-gray-100 dark:bg-gray-900 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-semibold mb-6">
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const loadAssets = async () => {
      try {
        console.log('[DEBUG] Loading assets for user:', user.id);
        const assetsData = await getAssetsByUser(user.id);
        console.log('[DEBUG] Assets fetched:', assetsData.length);
        setAssets(assetsData.map((a: any) => ({
          id: a.id,
          portfolioId: a.portfolioId,
          ownerId: a.ownerId,
          ...
          type: a.type,
          tefasType: a.tefasType,
          dividendYield: a.dividendYield ? parseFloat(a.dividendYield) : undefined,
          dividendGrowth5Y: a.dividendGrowth5Y ? parseFloat(a.dividendGrowth5Y) : undefined,
          dividendGrowth10Y: a.dividendGrowth10Y ? parseFloat(a.dividendGrowth10Y) : undefined,
          currentPrice: a.currentPrice ? parseFloat(a.currentPrice) : undefined,
          createdAt: a.createdAt,
        } as Asset)));
      } catch (error) {
